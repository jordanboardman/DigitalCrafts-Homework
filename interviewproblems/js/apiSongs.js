// // # Write a function to return just the song names from the top tracks list in the response. Use a for loop inside the function.
...
// // NOT A FUNCTION. DONT JUST LOOK AT W3SCHOOLS YA GOOB. READ THE DIRECTIONS.
// const songs = { name: "a m a r i" };
// const listSongs = JSON.parse(songs);
